                                        ...
                                        className={cn(
                                            ...
                                            scrolled
                                                ? (isActive(item.path)
                                                    ...
                                                    : item.isErpHighlight
                                                        ? "text-red-700 bg-red-50 border border-red-200 shadow-sm animate-pulse"
                                                        : "text-slate-700 hover:bg-slate-100")
                                                : (isActive(item.path)
                                                    ? "text-[#2196F3] bg-white shadow-xl transform scale-105"
                                                    : item.isErpHighlight
                                                        ? "text-white bg-red-600 shadow-xl hover:bg-red-500 border border-red-400 animate-pulse"
